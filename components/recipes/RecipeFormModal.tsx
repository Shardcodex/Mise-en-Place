    ...
    <Modal open={open} onClose={onClose} maxWidth="max-w-[720px]">
      ...
      <div className="px-8 py-6 space-y-5">
        ...
        <div className="flex items-end gap-4">
          <div>
            <label className="block font-medium text-[12px] text-ink-light mb-1.5">Emoji</label>
            <div
              className="w-14 h-14 rounded-full bg-bg-warm border border-border border-dashed flex items-center justify-center text-[28px] hover:bg-accent-bg transition-colors cursor-pointer"
              onClick={() =>
                setEmoji(EMOJIS[Math.floor(Math.random() * EMOJIS.length)])
              }
            >
